...
**A bio page.** Write a heading with your name, then two or three
paragraphs about yourself. Add a list of your interests and a link or
two you like.

**A recipe card.** Pick a dish you know well. Give it a heading, an
ordered list for the steps, and an unordered list for the ingredients.

**A review.** Choose a book or a film you have an opinion about. Write a
heading, a short summary, and a paragraph saying what you thought.

[`hello-world.html`](hello-world.html) and
[`first-page.html`](first-page.html) are two small pages to start from if
you want a file already in place rather than a blank one.
...
**A landing page.** Pick a product, real or invented. Give it a large
heading, a short pitch, a row of features side by side, and a footer.

**A photo gallery.** Lay out a grid of images, three or four to a row,
each with a caption. [`resume-template.html`](resume-template.html) uses
the same box and border ideas at a smaller scale, in a single-page layout
rather than a grid.
...
## A page that shows your data

Once you have a database and a page, put the two together. Draw a table
on the page and fill it from a query instead of typing it by hand. Add a
search box that narrows the rows, or a form that adds one. This is the
smallest project that uses both halves of the course at once, and any
idea above can supply the data behind it.

## Making any of them easy to read

A few choices affect every project on this page. Use a plain sans-serif
typeface for body text, at 16 pixels or larger. Keep a comfortable line
