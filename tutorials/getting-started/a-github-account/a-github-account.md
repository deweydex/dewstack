...
**A username.** This becomes part of your GitHub address and appears on
everything you publish. Choose something you would be happy to keep:
changing it later is possible, but it can break links to work you have
already shared.

**An email address.** GitHub sends account and security notices here, so
use one you check.

**A password.** GitHub will ask for one that meets its usual length and
complexity rules.
