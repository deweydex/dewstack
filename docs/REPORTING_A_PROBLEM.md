...
Most pages carry a line at the bottom, "Something wrong on this page?
Tell us." Click it and you see three choices.
...
Whichever you choose, all you need to add is the one thing that matters:
what happened.

If these choices are missing, or your report has no one page attached to
it (an idea, a suggestion, something about the site as a whole), opening
an issue yourself works the same way — **[the issue tracker on
GitHub](https://github.com/deweydex/dewstack/issues)**. You need a free
GitHub account to post one. Look at the open issues first in case somebody has already reported it — if they have, adding what you
...
These choices can be turned off for a while if reports need to pause,
for example while something is being fixed. When they are off, this page
and the issue tracker itself still work exactly as before.
...
to Reset. Click it, and you see the same three choices, this time
already knowing which cell you were on. Choose "It gives an error," and your
