...
| SQL practice page | `HTML-CSS-SQL-JS/index.html` | `tutorials/data/` | not started; `NEXT_STEPS.md` step 7 item 4 |
| Teaching notes | `HTML-CSS-SQL-JS/teacher.html` | `planning/` | not started |
| Plushies quiz | `WADB_Tutorials/tentacular-plushies-quiz-final.html` | `tutorials/data/` | not started; `NEXT_STEPS.md` step 7 item 4 |
