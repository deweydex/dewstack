...
The tutorials for this stage are moving into this repository. Until they
arrive, the database work starts here:
https://deweydex.github.io/HTML-CSS-SQL-JS/#sql-section
...
In the current stage 2 page, the database starts again each time the page
is reloaded. If you write a query you want to keep, copy it into a file of
your own.
