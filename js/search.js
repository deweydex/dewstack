...
function buildSearchIndex() {
    searchIndex = [
        ...
        // Start here and databases
        {
            title: 'Start Here: Build Your Own Site',
            type: 'Start here',
            url: 'index.html#start',
            keywords: ['start', 'starter', 'fork', 'portfolio', 'exercises', 'your own site', 'github pages'],
            description: 'Fork the starter site and work through its numbered exercises'
        },
        {
            title: 'SQL Playground',
            type: 'Database',
            url: 'databases/playground/index.html',
            keywords: ['sql', 'database', 'query', 'select', 'where', 'join', 'sqlite', 'playground', 'table'],
            description: 'Type a query, run it in the browser, see the result'
        },
        {
            title: 'SQL Playground: Teacher Version',
            type: 'Database',
            url: 'databases/playground/teacher.html',
            keywords: ['sql', 'teacher', 'solutions', 'answers', 'notes'],
            description: 'The playground with solutions and teaching notes'
        },
        {
            title: 'SQL Quiz',
            type: 'Database',
            url: 'databases/quiz.html',
            keywords: ['sql', 'quiz', 'practice', 'questions', 'plushies', 'shop'],
            description: 'Practice questions on a small shop database'
        },
        {
            title: 'SQLite Notebook',
            type: 'Database',
            url: 'databases/sqlite_tutorial.ipynb',
            keywords: ['sqlite', 'jupyter', 'notebook', 'colab', 'dinosaurs', 'python'],
            description: 'SQLite in a Jupyter notebook, with dinosaurs for data'
        },
